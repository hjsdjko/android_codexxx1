...
class MainActivity : BaseBindingActivity<ActivityMainLayoutBinding>() {
    ...
    private val fragments = mutableListOf(
        ...
        ARouter.getInstance().build(CommonArouteApi.PATH_FRAGMENT_LIST_NEWS).withBoolean("mHasBack",false).navigation() as Fragment,
        ARouter.getInstance().build(CommonArouteApi.PATH_FRAGMENT_LIST_KEFANGXINXI).withBoolean("mHasBack",false).navigation() as Fragment,
