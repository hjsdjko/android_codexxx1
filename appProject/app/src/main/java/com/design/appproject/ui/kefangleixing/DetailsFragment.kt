...
import com.design.appproject.logic.viewmodel.kefangleixing.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.KefangleixingcommonDetailsLayoutBinding
 ...
 * 客房类型详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_KEFANGLEIXING)
class DetailsFragment : BaseBindingFragment<KefangleixingcommonDetailsLayoutBinding>() {
    ...
    private var mKefangleixingItemBean=KefangleixingItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mKefangleixingItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("kefangleixing",mId.toString())
    }


    private fun KefangleixingcommonDetailsLayoutBinding.setInfo(){
        kefangleixingTv.text = "${mKefangleixingItemBean.kefangleixing}"
    }
